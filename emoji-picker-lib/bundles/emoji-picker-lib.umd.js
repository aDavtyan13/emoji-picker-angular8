(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('emoji-picker-lib', ['exports', '@angular/core', '@angular/forms', '@angular/common', 'rxjs'], factory) :
    (global = global || self, factory(global['emoji-picker-lib'] = {}, global.ng.core, global.ng.forms, global.ng.common, global.rxjs));
    ...
    var EmojisSharedService = /** @class */ (function () {
        function EmojisSharedService(emojiPickerService) {
            ...
            this.emojis = new rxjs.BehaviorSubject((/** @type {?} */ ({})));
    ...
    var EmojiPickerLibComponent = /** @class */ (function () {
        function EmojiPickerLibComponent(emojisSharedService) {
            ...
            this.selectEmojiEvent = new core.EventEmitter();
        ...
        EmojiPickerLibComponent.propDecorators = {
            emojiPickerOptions: [{ type: core.Input }],
            selectEmojiEvent: [{ type: core.Output }]
        };
    ...
    var OutClickDirective = /** @class */ (function () {
        function OutClickDirective(elRef) {
            this.elRef = elRef;
            this.outClickEvent = new core.EventEmitter();
        }
        /**
         * @param {?} event
         * @return {?}
        ...
        OutClickDirective.propDecorators = {
            outClickEvent: [{ type: core.Output }],
            toggleOpen: [{ type: core.HostListener, args: ['document:click', ['$event'],] }]
        };
    ...
    exports.EmojiPickerLibComponent = EmojiPickerLibComponent;
    exports.EmojiPickerLibModule = EmojiPickerLibModule;
    exports.EmojiPickerService = EmojiPickerService;
    exports.ɵa = OutClickDirective;
    exports.ɵb = AutofocusDirective;
    exports.ɵc = EmojisSharedService;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=emoji-picker-lib.umd.js.map
